...
#include "C_implementation/memory.h"
#include "C_implementation/helper_func.h"
#include "C_implementation/note.h"
#include "C_implementation/help.h"
#include "C_implementation/install.h"
